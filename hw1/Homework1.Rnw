...
E(\bar{X})= \frac{5}{12}
 ...
 <<histogram_1c, echo=FALSE, cache=TRUE, fig.align='center',fig.pos="H", fig.height = 3,  fig.width = 3, fig.cap="Histogram of 100,000 simulated values of the sample mean when the sample was taken with replacement">>=
 hist.wr
 @
...
$$SE(\bar{X}) = \sqrt{Var(\bar{X})} = \sqrt{\frac{1}{n} Var(t) \left[\frac{N - n}{N - 1}\right]} = \Sexpr{round(se.nr,3)}$$
 ...
 <<histogram_1e, echo=FALSE, cache=TRUE, fig.align='center',fig.pos="H", fig.height = 3,  fig.width = 3, fig.cap="Histogram of 100,000 simulated values of the sample mean when the sample was taken without replacement">>=
 hist.nr
 @
