...
E(\bar{X})= \frac{5}{12}
 ...
 <<histogram_1c, echo=FALSE, cache=TRUE, fig.align='center',fig.pos="H", fig.height = 3,  fig.width = 3, fig.cap="Histogram of 100,000 simulated values of the sample mean">>=
 hist.wr
 @
