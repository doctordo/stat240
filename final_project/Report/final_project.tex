...
To assess the practical difference between tracking and non-tracking schools, we focus the scores seen in table \ref{tab:practical}.  Let us suspend the discussion outside the context of p-values.  The difference scores means that on average the students in tracking schools were able to identify 10\% more words, understand 10\% more sentence meanings, and recognize 10\% letters than their non-tracked counterparts.  Certainly the effect is not huge, but all the value-added scores are positive, suggesting that tracking, at the very least, does not have a deleterious effect in the classroom on average.
